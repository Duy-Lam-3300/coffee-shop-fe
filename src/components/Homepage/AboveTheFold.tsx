...
<div className="">
        ...
        <div className="flex justify-between items-center mx-auto max-w-7xl h-[65vh] gap-16">
            <div className="w-1/2  left my-auto">
                ...
                <div className="flex gap-20 items-center my-8">
                    <button className="bg-[var(--main-color)] text-white p-2 px-4 rounded-xl font-semibold cursor-pointer">Explore more {">"}</button>
